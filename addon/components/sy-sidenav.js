...
export default Component.extend({
  ...
  autohide: computedLocalStorage("sy-sidenav-autohide", {
    defaultValue: false
  }),
  showAutohideButton: true,

  application: computed(function() {
    return getOwner(this).resolveRegistration("application:main");
  }),

  title: computed("application.name", function() {
    return this.get("application.name")
      ? capitalize(camelize(this.get("application.name")))
      : "";
  }),
